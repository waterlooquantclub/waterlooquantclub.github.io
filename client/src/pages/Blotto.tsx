          ...
          <div className="container mx-auto max-w-4xl space-y-6 relative z-10">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed text-base md:text-lg">
              <p>
                ...
                a tower, nobody is rewarded. Special scenario may take place to 
                affect how points are rewarded.
              </p>
            </div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed text-base md:text-lg">
              <p>
                1-3 scenarios will take place each week, where submissions 
                open from Monday to Sunday midnight. For each scenario, you 
                will submit a strategy to allocate your soldiers, which will 
                ...
                the average score from all individual 1v1 games. If you rank the i-th 
                place among n players who submitted for the tournament, a score
                of sqrt(n/i) is added to your cumulative total for the term 
