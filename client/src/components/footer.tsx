...
import { DISCORD_LINK, SECTIONS } from "../util/constants";

const SOCIALS = [
  {
    name: "Instagram",
    url: "https://instagram.com/uwaterlooquant",
    icon: (size: number) => <Instagram size={size} />,
  },
  {
    name: "LinkedIn",
    url: "https://linkedin.com/company/waterloo-quant-club",
    icon: (size: number) => <Linkedin size={size} />,
  },
  {
    name: "Discord",
    url: DISCORD_LINK,
  ...
  {
    name: "Email",
    url: "mailto:uwaterlooquantclub@gmail.com",
    icon: (size: number) => <Mail size={size} />,
  },
];
    ...
    <footer className="w-full bg-gradient-to-b from-black from-16% to-[#412445] py-8 md:py-12 rounded-tl-3xl rounded-tr-3xl">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-3 md:mt-4 text-center">
          <p className="text-xs md:text-sm text-[#EAD0ED]">
